...
import '../model/DemoProductList.dart';
          ...
          Stack(
            children: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CartScreen(), maintainState: true,));
                },
              ),
              Positioned(right: 8, top: 4,
                child: BlocBuilder<CartBloc, CartState>(
                    ...
                    builder: (context, cartState) {
                      if (cartState is CartOperationSuccess && cartState.cartItems.length > 0)
                        return Container(
